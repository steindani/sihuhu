...
/**
 * Pattern-specific match representation of the hu.bme.mit.rnd.behavior.incquery.componentStates pattern,
 * to be used in conjunction with {@link ComponentStatesMatcher}.
 * 
...
public abstract class ComponentStatesMatch extends BasePatternMatch {
  ...
  private ComponentStatesMatch(final Component pC, final State pS) {
    this.fC = pC;
    this.fS = pS;
  }
  ...
  public List<String> parameterNames() {
    return ComponentStatesMatch.parameterNames;
  }
  ...
  @Override
  public ComponentStatesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ComponentStatesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ComponentStatesMatch other = (ComponentStatesMatch) obj;
  ...
  @Override
  public ComponentStatesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ComponentStatesMatch newEmptyMatch() {
   ...
   * 
   */
  public static ComponentStatesMatch newMutableMatch(final Component pC, final State pS) {
   ...
   * 
   */
  public static ComponentStatesMatch newMatch(final Component pC, final State pS) {
    return new Immutable(pC, pS);
  }
  
  private static final class Mutable extends ComponentStatesMatch {
  ...
  private static final class Immutable extends ComponentStatesMatch {
