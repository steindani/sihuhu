...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.rnd.sihuhu.sihuhu.Track} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TrackItemProvider extends NamedElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SihuhuPackage.Literals.TRACK__RAILS);
			childrenFeatures.add(SihuhuPackage.Literals.TRACK__SWITCHES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SihuhuPackage.Literals.TRACK__RAILS,
				 SihuhuFactory.eINSTANCE.createRail()));
		...
		newChildDescriptors.add
			(createChildParameter
				(SihuhuPackage.Literals.TRACK__SWITCHES,
				 SihuhuFactory.eINSTANCE.createSwitch()));
	}
