...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.rnd.sihuhu.sihuhu.World} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorldItemProvider extends NamedElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SihuhuPackage.Literals.WORLD__TRACKS);
			childrenFeatures.add(SihuhuPackage.Literals.WORLD__TRAINS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SihuhuPackage.Literals.WORLD__TRACKS,
				 SihuhuFactory.eINSTANCE.createTrack()));

		newChildDescriptors.add
			(createChildParameter
				(SihuhuPackage.Literals.WORLD__TRAINS,
				 SihuhuFactory.eINSTANCE.createTrain()));
	}
