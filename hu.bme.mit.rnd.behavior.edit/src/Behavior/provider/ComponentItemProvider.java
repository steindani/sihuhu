...
/**
 * This is the item provider adapter for a {@link Behavior.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Component_currentState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Component_currentState_feature", "_UI_Component_type"),
				 BehaviorPackage.Literals.COMPONENT__CURRENT_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BehaviorPackage.Literals.COMPONENT__STATES);
			childrenFeatures.add(BehaviorPackage.Literals.COMPONENT__TRANSITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.COMPONENT__STATES,
				 BehaviorFactory.eINSTANCE.createState()));

		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.COMPONENT__TRANSITIONS,
